...
def home_keyboard() -> InlineKeyboardMarkup:
    return markup(
        [
            row(button("📚 TEST INDEX", "index:categories")),
            row(button("🚀 EXTRACT TEST", "index:categories")),
            row(
                button("💎 PREMIUM", "menu:premium"),
                button("🎁 FREE TRIAL", "menu:trial"),
            ),
            row(
                button("👤 MY ACCOUNT", "menu:userinfo"),
                button("💰 PRICE", "menu:price"),
            ),
            row(
                button("📢 JOIN CHANNEL", "menu:channels"),
                button("📞 REPORT", "menu:report"),
            ),
            row(button("📋 COMMAND MENU", "menu:commands")),
            row(home_button()),
        ]
    )
