...
class PaymentHandlers:
    ...
    async def select_plan(
        ...
        payment_text = db.get_setting(
            "payment_message",
            "💳 Payment instructions Admin द्वारा configure नहीं की गई हैं।",
        )
        ...
        text = (
            ...
            f"{payment_text}\n\n"
            "Payment करने के बाद screenshot भेजें।"
        )

        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("❌ CANCEL", callback_data=f"payment:cancel:{payment_id}")],
            [InlineKeyboardButton("🏠 HOME", callback_data="home")],
        ])

        context.user_data["payment_screenshot"] = payment_id
        await self.send_or_edit(update, context, text, keyboard)
    ...
    async def save_screenshot(
        ...
        channel = db.get_channel("payment")
